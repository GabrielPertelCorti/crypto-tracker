  ...
  return (
    <div className={styles.container} >
      ...
      <section className={styles.content}>
        ...
        <a>
          <strong>Market Cap:</strong> {coin?.formatedMarketCap}
        </a>
        ...
        <a>
          <strong>Variação:</strong> <span className={Number(coin?.changePercent24Hr > 0</span>} >{Number(coin?.changePercent24Hr).toFixed(2) + "%"}</span>
        </a>
